    ...
    .row.justify-content-center.my-5
      .col-lg-9.mt-5
        ...
        AcordionA(tipo="b" clase-tarjeta="tarjeta tarjeta--gris")
          ...
          .row(titulo="Identificación de patrones de conducta")
            p Para los psicólogos es vital la identificación de los patrones propios de cada persona porque determinan sus deseos y reacciones. Esencialmente un patrón de comportamiento se constituye de 4 componentes básicos: creencias o pensamientos; sentimientos y emociones, comportamientos y, finalmente, reacciones corporales.
    ...
    .row.justify-content-center.my-5
      ...
      .col-lg-8
        ...
        .cajon.color-acento-contenido.p-3
          p Para ampliar la información de las diferentes clasificaciones, revise el <b>Anexo 8. Patrones de conducta</b>, en la sección clasificación, en la cual se describen aspectos relacionados con estas conductas y las generaciones conocidas como Baby Boomers, Generación X, Y los Millennials y Z o Centennials.
          .row
            .col-lg-6
    ...
    .row.my-5
      .col-lg-10
        .cajon.color-acento-contenido.p-3.my-5
          p Para ampliar la información revise el <b>Anexo 9. Herramientas para medir el comportamiento</b>, en la sección de herramientas para medir el comportamiento, donde encontrará información detallada sobre estas. 
          .row
            .col-lg-6
